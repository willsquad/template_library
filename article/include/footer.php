<div class="container-fluid">
    <div class="header_collection_body text-center d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="header_collection_list d-flex flex-wrap">
            <a class="<?php echo ($page_name == 'index.php'?'active': ''); ?>" href="index.php">Article 1</a>
            <a class="<?php echo ($page_name == 'article-2.php'?'active': ''); ?>" href="article-2.php">Article 2</a>
            ...
            <a class="<?php echo ($page_name == 'article-8.php'?'active': ''); ?>" href="article-8.php">Article 8</a>
            <a class="<?php echo ($page_name == 'article-9.php'?'active': ''); ?>" href="article-9.php">Article 9</a>
            <a class="<?php echo ($page_name == 'article-10.php'?'active': ''); ?>" href="article-10.php">Article 10</a>
        </div>
