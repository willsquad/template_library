...
<html lang="en">
  <head>
    ...
    <title><?php echo (isset($title)? $title : 'FAQ') ?></title>
    <!-- Bootstrap CSS -->
    ...
    ?>
    <link rel="stylesheet" href="../_files/css/faq.css">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Lato|Ubuntu|Oxygen|Roboto:300,500|Roboto+Slab|Montserrat:300,500,700|Lobster" rel="stylesheet">
            ...
            <div class="col-12">
                 <div class="footer_collection_body text-center d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="header_collection_list d-flex flex-wrap">
                        <a class="<?php echo ($page_name == 'index.php'?'active': ''); ?>"  href="index.php">FAQ 1</a>
                        <a class="<?php echo ($page_name == 'faq-2.php'?'active': ''); ?>" href="faq-2.php">FAQ 2</a>
                        <a class="<?php echo ($page_name == 'faq-3.php'?'active': ''); ?>" href="faq-3.php">FAQ 3</a>
                        <a class="<?php echo ($page_name == 'faq-4.php'?'active': ''); ?>" href="faq-4.php">FAQ 4</a>
                        <a class="<?php echo ($page_name == 'faq-5.php'?'active': ''); ?>" href="faq-5.php">FAQ 5</a>
                        <a class="<?php echo ($page_name == 'faq-6.php'?'active': ''); ?>" href="faq-6.php">FAQ 6</a>
                     </div>
