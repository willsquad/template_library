...
<html lang="en">
  <head>
    ...
    ?>
    <link rel="stylesheet" href="../_files/css/form.css">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Lato|Ubuntu|Source+Sans+Pro:300,400,600|Roboto:300,500|Roboto+Slab|Montserrat:300,500,700|Lobster" rel="stylesheet">
            ...
            <div class="col-12">
                 <div class="footer_collection_body text-center d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="header_collection_list d-flex flex-wrap">
                        <a class="<?php echo ($page_name == 'index.php'?'active': ''); ?>"  href="index.php">Form 1</a>
                        <a class="<?php echo ($page_name == 'form-2.php'?'active': ''); ?>" href="form-2.php">Form 2</a>
                        <a class="<?php echo ($page_name == 'form-3.php'?'active': ''); ?>" href="form-3.php">Form 3</a>
                        <a class="<?php echo ($page_name == 'form-4.php'?'active': ''); ?>" href="form-4.php">Form 4</a>
                        <a class="<?php echo ($page_name == 'form-5.php'?'active': ''); ?>" href="form-5.php">Form 5</a>
                        <a class="<?php echo ($page_name == 'form-6.php'?'active': ''); ?>" href="form-6.php">Form 6</a>
                     </div>
