...
<html lang="en">
  <head>
    ...
    <title><?php echo (isset($title)? $title : 'Input') ?></title>
    <!-- Bootstrap CSS -->
    ...
    ?>
    <link rel="stylesheet" href="../_files/css/input.css">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Raleway|Lato|Ubuntu|Oxygen|Roboto:300,500|Roboto+Slab|Montserrat:300,500,700|Lobster" rel="stylesheet">
            ...
            <div class="col-12">
                 <div class="footer_collection_body text-center d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="header_collection_list d-flex flex-wrap">
                        <a class="<?php echo ($page_name == 'index.php'?'active': ''); ?>"  href="index.php">Input : Text</a>
                        <a class="<?php echo ($page_name == 'input-2.php'?'active': ''); ?>" href="input-2.php">Input : Select</a>
                        <a class="<?php echo ($page_name == 'input-3.php'?'active': ''); ?>" href="input-3.php">Input : Checkbox | Radio</a>
                        <a class="<?php echo ($page_name == 'input-4.php'?'active': ''); ?>" href="input-4.php">Input : Buttons</a>
                     </div>
