                ...
                <div class="col-12 col-sm-10 offset-sm-1 landing_content_container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-8 col-md-8 col-lg-6 landing_lhs d-flex justify-content-center flex-column align-items-sm-start align-items-center">
                            ...
                            <p class="landing_p">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias corporis facere, architecto quia
                                blanditiis quaerat ullam placeat, omnis deleniti, iusto velit.</p>
                            <div class="input_button_container">
                                <input type="text">
                                <button class="landing_button">Subscribe</button>
                            </div>
                        </div>
                    </div>
                </div>
