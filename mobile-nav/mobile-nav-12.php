...
$title = 'Mobile Nav 112';
include('include/header.php');

?>

<div class="container-fluid no-gutters">
    <div id="mobile_12" class="row mobile_screen">
...
<script>
    ...
    function openNav() {
        document.getElementById("mobile_side_nav").style.maxHeight = "705px";
        document.getElementById("mobile_side_nav").style.visibility = "visible";
    ...
    function closeNav() {
        ...
        document.getElementById("mobile_side_nav").style.visibility = "hidden";
        //document.getElementById("top_search").style.visibility = "hidden";
        document.getElementById("mobile_side_nav").style.maxHeight = "0";
