<div class="container-fluid">
    <div class="header_collection_body text-center d-flex flex-column justify-content-center align-items-center col-12 col-sm-8 offset-sm-4 col-md-8 offset-md-4 col-lg-9 offset-lg-3 col-xl-10 offset-xl-2">

        <img src="../_files/images/demo-arrow.png" style="transform: rotate(-90deg);" alt="arrow" height="120">

        <h1>Vertical Navigation</h1>

        <div class="header_collection_list d-flex flex-wrap">
            <a class="<?php echo ($page_name == 'index.php'?'active': ''); ?>" href="index.php">Vertical 1</a>
            <a class="<?php echo ($page_name == 'vertical-nav-2.php'?'active': ''); ?>" href="vertical-nav-2.php">Vertical 2</a>
